...
public class LineChartFragment extends Fragment implements OnChartValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        {   // // Chart Style // //
            chart = root.findViewById(R.id.linearChart);
            ...
            MyMarkerView mv = new MyMarkerView(container.getContext(), R.layout.custom_marker_view);
    ...
    private void setData(int count, float range, ViewGroup container) {
        ...
        if (chart.getData() != null &&
            ...
            if (Utils.getSDKInt() >= 18) {
                ...
                Drawable drawable = ContextCompat.getDrawable(container.getContext(), R.drawable.fade_red);
